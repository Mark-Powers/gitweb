...
sub git_summary {
	...
	if (esc_html($descr) !~ /^Unnamed repository/) {
		print "<tr id=\"metadata_desc\"><td>description</td><td>" . esc_html($descr) . "</td></tr>\n";
	}
	...
	print "<tr><td>code:</td><td>git clone git://marks.kitchen/$project</td></tr>\n";
	...
	git_tree_only();
	#$cgi->a({-href => href(action=>"tree",	                 hash_base=>"HEAD", file_name=>$file_name)},
	#print $cgi->a({-href => href(action=>"tree", hash_base=>$proj_head_hash), class => "list"}, '?');
...
sub git_tree_only {
	...
	my $basedir = '';
	print "<div class=\"header title\">files</div>\n";
	print "<div class=\"page_body\">\n";
